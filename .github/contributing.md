...
# Contributing to Legerdemain

Firstly, thank you for taking an interesting in contributing! Legerdemain is an
...
Legerdemain is one of a large number of
...
issue](https://github.com/propensive/legerdemain/issues) or contact the project
...
have commit rights to the `propensive/legerdemain` repository, push to a branch named
...
in extreme cases. Legerdemain does not use automatic code-formatting because it
...
Legerdemain&rsquo;s users. Individualism is valued, and nobody should feel
